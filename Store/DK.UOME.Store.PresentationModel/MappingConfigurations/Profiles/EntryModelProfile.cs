...
using DK.UOME.Store.PresentationModel.MappingConfigurations.ValueResolvers;
using System;
using System.Collections.Generic;
using StorageModel = DK.UOME.DataAccess.DataModel;
using UIModel = DK.UOME.Store.UI.DataModel;

namespace DK.UOME.Store.PresentationModel.MappingConfigurations.Profiles
{
    internal class EntryModelProfile  : Profile
    {
        ...
        public static UIModel.Entry MapEntry(StorageModel.Entry sourceEntry)
        {
            ...
            {
                case 0:
                    return Mapper.Map<LoanedEntry>(sourceEntry);

                case 1:
                    return Mapper.Map<BorrowedEntry>(sourceEntry);
